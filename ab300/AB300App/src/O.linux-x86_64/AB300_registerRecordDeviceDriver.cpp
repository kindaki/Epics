...
/* Generated from ../O.Common/AB300.dbd */
...
epicsShareExtern dset *pvar_dset_devLiAB300;
...
int AB300_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/linux/epics/modules/instrument/ab300";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"AB300_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    AB300_registerRecordDeviceDriver(*iocshPpdbbase);
}
